...
python3 create_desktop_file.py --app_name="NukeSamurai" --version=$1 --latest_path="$1"/nukesamura-start.sh --categories="nuke, samurai" --destination="$1" --icon="$1"/nuke.png --terminal="False"
