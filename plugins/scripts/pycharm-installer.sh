...
echo "Downloading pycharm-community-$1"
...
python3 create_desktop_file.py --app_name="Pycharm" --version="Juno" --latest_path="$2/latest" --categories="pycharm, ide" --destination="$2" --icon="$2"/pycharm.png
